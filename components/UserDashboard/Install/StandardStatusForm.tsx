...
/* === Component === */
const StandardStatusForm: React.FC = () => {
  // Form state
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const purchaseRef = doc(firestore, "standard", user.uid);
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        <div>
          ...
          >
            Installation Components — Standard Plan
          </h2>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/5 rounded-3xl border border-white/10 p-6">
            ...
            <p className="text-sm text-gray-300 mb-6">
              These are pre-included in the Standard installation. Click a card
...
export default StandardStatusForm;
